...
mixexptr is an R package for analyzing microbial mix experiments. mixexptr provides tools to calculate and plot fitness measures that help researchers get the most out of their data and quantitatively compare results across systems. 
